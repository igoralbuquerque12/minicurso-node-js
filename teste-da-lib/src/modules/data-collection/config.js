const SUMMARY_HEADLINE_LIMIT = 8;

const ANALYSIS_SYSTEM_PROMPT = `Você atua como um Analista de Monitoramento de Sistemas e Engenheiro de Automação.
